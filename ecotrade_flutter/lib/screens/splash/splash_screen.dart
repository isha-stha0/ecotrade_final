...
class _SplashScreenState extends State<SplashScreen>
  ...
  void initState() {
    ...
    _fade = CurvedAnimation(parent: _text, curve: Curves.easeIn)
        .drive(Tween(begin: 0.0, end: 1.0));
    _slide = CurvedAnimation(parent: _text, curve: Curves.easeOut)
  ...
  Future<void> _run() async {
    ...
    Navigator.of(context)
        .pushReplacementNamed(auth.isLoggedIn ? '/main' : '/onboarding');
  }
            ...
            builder: (_, __) => Opacity(
              ...
              child: Transform.translate(
                ...
                child: Column(children: [
                  ...
                  const Text('Smart Recycling Marketplace',
                      style: TextStyle(
                          fontSize: 14,
                  ...
                  child: Column(children: [
                    SizedBox(
                        ...
                        child: LinearProgressIndicator(
                            ...
                            valueColor:
                                AlwaysStoppedAnimation(AppColors.green500),
                            minHeight: 2)),
                    SizedBox(height: 12),
                    Text("Nepal's Green Marketplace 🌱",
                        style:
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 3; i++) {
      canvas.drawArc(
          ...
          Paint()
            ..color =
                [AppColors.green500, AppColors.green600, AppColors.green400][i]
            ..strokeWidth = 3
