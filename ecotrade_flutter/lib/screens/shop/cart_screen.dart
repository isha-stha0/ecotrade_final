...
class CartScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Cart (${cart.count})'), actions: [
        if (cart.items.isNotEmpty)
          TextButton(
              onPressed: cart.clear,
              child:
                  const Text('Clear', style: TextStyle(color: AppColors.red)))
      ]),
      body: cart.items.isEmpty
          ? const EmptyState(
              emoji: '🛍️',
              title: 'Cart is empty',
              subtitle: 'Add some eco-friendly products!')
          : Column(children: [
              Expanded(
                    ...
                    child: Row(children: [
                      ...
                      Expanded(
                          child: Column(
                            ...
                            Text(
                                'NPR ${item.product.price.toStringAsFixed(0)} each',
                                style: const TextStyle(
                      ...
                      children: [
                        const Text('Total',
                            style: TextStyle(
                                ...
                                fontWeight: FontWeight.w700,
                                color: AppColors.textPrimary)),
                        Text('NPR ${cart.total.toStringAsFixed(0)}',
                            style: const TextStyle(
                                fontSize: 20,
